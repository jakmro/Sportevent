...
urlpatterns = [
    ...
    path('<int:pk>/delete_event/', DeleteEventView.as_view(), name='delete_event'),
    path('<int:pk>/register_for_event/', EventRegistrationView.as_view(), name='register_for_event')
]
